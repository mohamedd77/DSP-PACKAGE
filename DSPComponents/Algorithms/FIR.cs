        ...
        public override void Run()
        {
            ...
            else if (InputStopBandAttenuation > 21 && InputStopBandAttenuation <= 44)
            {
                ...
                for (int i = (int)(N * -1); i <= N; i++)
                {
                    ...
                    //OutputYn.Samples.Add((float)(0.5f + 0.5f * Math.Cos((2 * Math.PI * i) / N * 2)));
                }
            }
            else if (InputStopBandAttenuation > 44 && InputStopBandAttenuation <= 53)
            {
                ...
                for (int i = (int)(N * -1); i <= N; i++)
                {
                    ...
                    //OutputYn.Samples.Add((float)(0.54f + 0.46f * Math.Cos((2 * Math.PI * i) / N * 2)));
                }
            ...
            StreamWriter str = new StreamWriter("coftients.txt", false);
            for (int i = 0; i < OutputHn.Samples.Count; i++)
            {
                str.WriteLine("value:" + OutputHn.Samples[i]);
            }
            str.Close();
